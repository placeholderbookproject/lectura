...
const AuthorGeneral = props => {
    const {lang, author, setAuthor, navigate, setTextName, userData, author_id} = props.properties
    ...
    return (<TabComponent properties={{userData, tabs, tabOpen, setTabOpen, data:author, type:"author", id}} />)
}
