...
const Comment = ({data, userData, type, type_id}) => {
        ...
        <div className="comment-container">
            ...
            ?<div className="comment-content">
                ...
                <div className="comment-interaction-container">
                    ...
                    <AddComment properties={{user_id:userData.user_id, hash:userData.hash, parent_comment_id:comment_id, type, type_id, buttonName:"Reply"}} />
                </div>
            </div>
            ...
            <div className="comment-div">
                ...
                {(userData.user_id === user_id||userData.user_role==='administrator')&&<>
